        ...
        <div className="p-10 border-b border-slate-100">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-2xl text-[11px] font-bold outline-none focus:border-[#7CB342]"
            />
          </div>
        </div>
          ...
          {filteredViews.map(view => (
            <div key={view.id} className="group relative">
              ...
              >
                ...
                <ChevronRight size={16} className={editingView?.id === view.id ? 'text-[#7CB342]' : 'text-slate-200'} />
              </button>
              <button 
          ...
          <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <header className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] font-black text-[#7CB342] uppercase tracking-[0.3em] mt-3 italic">Configuración de Origen de Datos</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="p-10 bg-white rounded-[3rem] border border-slate-100 shadow-sm space-y-8">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full p-5 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold outline-none focus:border-[#7CB342] transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full p-5 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold outline-none focus:border-[#7CB342] transition-all appearance-none"
                  >
              ...
              <div className="p-10 bg-white rounded-[3rem] border border-slate-100 shadow-sm flex flex-col h-full">
                <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-8 flex justify-between">
                  ...
                  <span className="text-[#7CB342]">{formData.columns.length} Seleccionadas</span>
                </label>
                  ...
                  <div className="flex-1 overflow-y-auto grid grid-cols-1 gap-3 pr-2 scrollbar-thin">
                    {(selectedEntity.attributes || []).map((attr: any) => {
                      ...
                      return (
                        ...
                        >
                          {isSelected ? <CheckSquare size={16} className="text-[#7CB342]" /> : <Square size={16} />}
